...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "connectAndJoinSession", function() { return connectAndJoinSession; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "connectAndNewSession", function() { return connectAndNewSession; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initClient", function() { return initClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "joinSession", function() { return joinSession; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "newSession", function() { return newSession; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_drawr__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_drawr___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_drawr__);

console.log(__WEBPACK_IMPORTED_MODULE_0_drawr___default.a)
let canvas = new __WEBPACK_IMPORTED_MODULE_0_drawr___default.a.DrawrCanvas('canvasDiv', JSON.parse(Android.getOptions()));
let client;
...
function initClient(username, options) {
    client = new __WEBPACK_IMPORTED_MODULE_0_drawr___default.a.DrawrClient({
        name: username,
        id: '0'
    }, options);
