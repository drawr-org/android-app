...
/**
 * Created by l.juenemann on 03.11.2016.
 */
...
/**
 * The icon can be changed via
 *
 * <pre>
 * android:drawable(Right|Left)="@drawable/custom_icon"
 * </pre>
 */
public class CustomEditText extends EditText implements OnTouchListener, OnFocusChangeListener, TextWatcherListener {
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        if (hasFocus) {
            setIconVisible(isNotEmpty(getText()));
        } else {
    ...
    public void onTextChanged(EditText view, String text) {
        if (isFocused()) {
            setIconVisible(isNotEmpty(text));
        }
    }
